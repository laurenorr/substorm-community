%<networki_function_maker.m Load R files and create network files.>
...
[networks3_v4_w128_t5]=NETSFIND(Substorms_v4_w128_t5);
save('networks3_v4_w128_t5.mat','networks3_v4_w128_t5','-v6')

%Network with community information
[networki_v4_w128_t5]=unspec_no_comms(networks3_v4_w128_t5,'w128_t5');
[networki_v4_w128_t5]=bitgiverer(networki_v4_w128_t5);
networki_v4_w128_t5=modularity_putter(networki_v4_w128_t5,'w128_t5');
networki_v4_w128_t5.all=alpha_calculater(Substorms_v4_w128_t5,networki_v4_w128_t5.all);
save(['networki_v4_w128_t5.mat'],'networki_v4_w128_t5','-v7.3')
...
%Load R modularity files
    for num=1:116
              load(['R/',num2str(num),'modularity_eb_v4_',num2str(Threshold),'.mat'])
...
for num=1:116
    load(['R/',num2str(num),'communities_eb_v4_',num2str(Threshold),'.mat'])
    net=Networks{num,1}; 
    duration=size(net,1);
    netw.all=Networks;
    for tm=1:duration
