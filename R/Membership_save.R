...
Substorms=readMat("RSubstorms_v4_w128_t5.mat")
mysubs<-0
for(n in seq(1,116,by=1)){
    mysubs<-Substorms[["Substorms.v4.w128.t5"]][[n]][[1]]
    m=dim(mysubs)[3]
    nstats=dim(mysubs)[2]
  ...
  writeMat(paste(n,"modularity_eb_v4_w128_t5",".mat",sep=""),modularity_eb=modularity_eb,fixNames = TRUE,onWrite=NULL)
  writeMat(paste(n,"communities_eb_v4_w128_t5",".mat",sep=""), 
  cluster_list_eb=cluster_list_eb,fixNames = TRUE,onWrite=NULL)}
